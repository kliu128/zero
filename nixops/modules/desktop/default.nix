...

{
  ...
  environment.systemPackages = with pkgs; [
    ...
    calibre chromium clementine discord emacs filezilla firebird-emu gnome3.gnome-disk-utility jetbrains.pycharm-community keepassxc libreoffice-still liferea mate.atril pavucontrol thunderbird transmission_gtk transmission_remote_gtk vokoscreen vlc vscode youtube-dl zoom-us
