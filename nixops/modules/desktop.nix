...

{
  ...
  home-manager.users.kevin = {
    ...
    home.packages = with pkgs; [
      ...
      android-studio arduino atom calibre cantata chromium clementine codeblocks discord emacs filezilla firebird-emu firefox gnome3.gnome-disk-utility google-chrome gpodder hexchat jetbrains.idea-community jetbrains.pycharm-community keepassxc liferea mate.atril mkvtoolnix mpv pavucontrol skypeforlinux simple-scan slack thunderbird tor-browser-bundle transmission_gtk transmission_remote_gtk vlc vscode wine winetricks youtube-dl zoom-us
      # Desktop tools
      ...
      # Desktop environment
      arandr blueman conky dolphin i3lock nitrogen system-config-printer scrot xautolock xcape xcompmgr termite
    ];
